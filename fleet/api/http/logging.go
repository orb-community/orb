...
func (l loggingMiddleware) ListAgentGroups(ctx context.Context, token string, pm fleet.PageMetadata, ownerID ...*string) (_ fleet.PageAgentGroup, err error) {
	defer func(begin time.Time) {
		if err != nil {
	...
	return l.svc.ListAgentGroups(ctx, token, pm, ownerID[0])
}
