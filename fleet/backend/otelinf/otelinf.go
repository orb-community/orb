...
func (p otelinfBackend) Metadata() interface{} {
	return struct {
...
func (p otelinfBackend) MakeHandler(tracer opentracing.Tracer, opts []kithttp.ServerOption, r *bone.Mux) {
	MakeOtelinfHandler(tracer, p, opts, r)
}

// TODO remove handlers
func (p otelinfBackend) handlers() (_ types.Metadata, err error) {
...
// TODO remove inputs
func (p otelinfBackend) inputs() (_ types.Metadata, err error) {
	var handlers types.Metadata
...
// TODO remove taps
func (p otelinfBackend) taps(ctx context.Context, ownerID string) ([]types.Metadata, error) {
...
func Register(auth mainflux.AuthServiceClient, agentRepo fleet.AgentRepository) bool {
	backend.Register("otelinf", &otelinfBackend{
		Backend:     "otelinf",
		Description: "open telemetry collector contrib",
		auth:        auth,
		agentRepo:   agentRepo,
	})
	return true
