...
func viewAgentBackendHandlerEndpoint(dio otelBackend) endpoint.Endpoint {
...
func viewAgentBackendInputEndpoint(dio otelBackend) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
		req := request.(viewResourceReq)
		if err := req.validate(); err != nil {
			return nil, err
...
func viewAgentBackendTapsEndpoint(dio otelBackend) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
		req := request.(viewResourceReq)
		if err := req.validate(); err != nil {
			return nil, err
