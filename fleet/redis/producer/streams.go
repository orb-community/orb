...
func (es eventStore) ListAgentGroups(ctx context.Context, token string, pm fleet.PageMetadata, ownerID ...*string) (fleet.PageAgentGroup, error) {
	return es.svc.ListAgentGroups(ctx, token, pm, ownerID[0])
}
