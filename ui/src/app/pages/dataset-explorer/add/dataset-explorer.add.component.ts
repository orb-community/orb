...
@Component({
  ...
  templateUrl: './dataset-explorer.add.component.html',
  styleUrls: ['./dataset-explorer.add.component.scss'],
})
export class DatasetExplorerAddComponent {
  editorMetadata = '';
  ...
  @Input() action: string = '';
  constructor(
    protected dialogRef: NbDialogRef<DatasetExplorerAddComponent>,
