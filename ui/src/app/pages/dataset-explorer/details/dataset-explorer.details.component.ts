...
@Component({
  selector: 'ngx-dataset-explorer-details-component',
  templateUrl: './dataset-explorer.details.component.html',
  styleUrls: ['./dataset-explorer.details.component.scss'],
})
export class DatasetExplorerDetailsComponent implements OnInit {
  offset = 0;
  limit = 20;
