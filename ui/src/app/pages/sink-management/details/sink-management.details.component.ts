...
@Component({
  ...
  templateUrl: './sink-management.details.component.html',
  styleUrls: ['./sink-management.details.component.scss'],
})
export class SinkManagementDetailsComponent implements OnInit {
  offset = 0;
  limit = 20;
