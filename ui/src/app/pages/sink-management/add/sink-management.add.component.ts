...
@Component({
  ...
  templateUrl: './sink-management.add.component.html',
  styleUrls: ['./sink-management.add.component.scss'],
})
export class SinkManagementAddComponent {
  editorMetadata = '';
  ...
  @Input() action: string = '';
  constructor(
    protected dialogRef: NbDialogRef<SinkManagementAddComponent>,
