...
@Component({
  selector: 'ngx-fleet-management-details-component',
  templateUrl: './fleet-management.details.component.html',
  styleUrls: ['./fleet-management.details.component.scss'],
})
export class FleetManagementDetailsComponent implements OnInit {
  offset = 0;
  limit = 20;
