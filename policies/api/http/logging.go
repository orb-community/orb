...
func (l loggingMiddleware) RetrievePolicyByID(ctx context.Context, token string, policyID string) (_ policies.Policy, err error) {
	...
	return l.svc.RetrievePolicyByID(ctx, token, policyID)
}
