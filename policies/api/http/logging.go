...
func (l loggingMiddleware) DuplicatePolicy(ctx context.Context, token string, policyID string) (_ policies.Policy, err error) {
	defer func(begin time.Time) {
		if err != nil {
	...
	return l.svc.DuplicatePolicy(ctx, token, policyID)
}
