...
func (e eventStore) DeleteAgentGroupFromAllDatasets(ctx context.Context, aGroupID string, token string) error {
	return e.svc.DeleteAgentGroupFromAllDatasets(ctx, aGroupID, token)
}
